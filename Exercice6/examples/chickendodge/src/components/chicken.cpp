...
namespace ChickenDodge
{
  ...
  void ChickenComponent::UpdateLogic(const Timing& timing)
  {
    ...
    if (distance > 500.F)
    {
      ...
      ChickenSpawnerComponent::chickenCount--;
      AudioSystem::SetProperty("NbChicken", ChickenSpawnerComponent::chickenCount);
    }
  }
  ...
  void ChickenComponent::Drop(nlohmann::json dropTemplate)
  {
    ...
    if(dropTemplate == rupeeTemplate) {
      AudioSystem::SendEvent("rupee_drop");
    } else if (dropTemplate == heartTemplate){
